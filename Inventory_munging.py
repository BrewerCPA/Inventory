...
def inv_clean_out(df): 
    ...
    """
    df.to_csv(f'C:/Users/chase/OneDrive/Desktop/Balance Sheet/Inventory/Ekos Inventory Analysis/Clean/{year}.{month:02}.{day} Clean Inv.csv', index=False)
...
if __name__ == '__main__':
    ...
    for i in files:
        ...
        df = drop_inv_rows(df)
        df = drop_inv_cols(df)
        year, month, day = Inventory_glob.file_dates(i)
